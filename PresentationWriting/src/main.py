from PresentationWriting.src.graph import graph
from PresentationWriting.src.states import State
from WebScraper.state import User
from PresentationWriting.src.pres import generate_modern_presentation
from PresentationWriting.src.utils import  get_color_from_image
